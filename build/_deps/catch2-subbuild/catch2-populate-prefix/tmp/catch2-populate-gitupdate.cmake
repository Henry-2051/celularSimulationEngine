...
execute_process(
  COMMAND "/run/current-system/sw/bin/git" --git-dir=.git show-ref "v3.4.0"
  WORKING_DIRECTORY "/home/quartz/sync/codingProjects/celularSimulationEngine/build/_deps/catch2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/quartz/sync/codingProjects/celularSimulationEngine/build/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/quartz/sync/codingProjects/celularSimulationEngine/build/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
