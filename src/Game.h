...
using confOption = std::variant<int, size_t, bool, std::string>;
...
class Game
{
    ...
    void init(LoadedConfig l_config);
    void sUserInput();
    void sRender();
    void update();
    ...
    void tryIgnite();
    void initializeSFML2(LoadedConfig & l_config);

    LoadedConfig load_config(std::string filePath);
